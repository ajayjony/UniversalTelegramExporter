...
class FakeHTTPSResponse:
    ...
    def read(self):
        if self.status == 200:
            return b'{"name":"v0.0.0 2022-03-02","tag_name":"v0.0.0", "html_url":"https://github.com/ajayjony/UniversalTelegramExporter/releases/tag/v0.0.0"}'
        else:
            return b"{error}"
...
class UpdatesTestCase(unittest.TestCase):
    ...
    def test_update(self, mock_markdown, mock_console):
        ...
        html_url: str = (
            "https://github.com/ajayjony/UniversalTelegramExporter/releases/tag/v0.0.0"
        )
